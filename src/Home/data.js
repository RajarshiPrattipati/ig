export const header = [
  {
    ...
    children: [
      {
        title: 'Influencer\'s Gig', desc: 'The Community for Influencers', img: 'https://gw.alipayobjects.com/zos/rmsportal/fLPzRmwAurHkPDVfHHiQ.svg', link: 'https://fengdie.alipay-eco.com/intro', top: '2px',
      },
    ],
  },
  {
    ...
    children: [
      {
        title: 'Search', desc: 'our global directory', img: 'https://gw.alipayobjects.com/zos/rmsportal/zMeJnhxAtpXPZAUhUKJH.svg', link: 'https://ant.design/docs/spec/values-cn',
      },
      {
        title: 'Launch', desc: 'with a free listing', img: 'https://gw.alipayobjects.com/zos/rmsportal/qkNZxQRDqvFJscXVDmKp.svg', link: 'https://ant.design/docs/spec/colors-cn',
      },
      {
        title: 'Control', desc: 'your information', img: 'https://gw.alipayobjects.com/zos/rmsportal/MrUQjZNOJhYJCSZZuJDr.svg', link: 'https://antv.alipay.com/zh-cn/vis/index.html',
      },
    ],
  },
  {
    ...
    children: [
      {
        title: 'Connect', desc: 'to the ecosystem', img: 'https://gw.alipayobjects.com/zos/rmsportal/ruHbkzzMKShUpDYMEmHM.svg', link: 'https://ant.design',
      },
      {
        title: 'Expand', desc: 'your network', img: 'https://gw.alipayobjects.com/zos/rmsportal/crqUoMinEgjMeGGFAKzG.svg', link: 'https://antv.alipay.com',
      },
      {
        title: 'Explore', desc: 'new solutions', img: 'https://gw.alipayobjects.com/zos/rmsportal/nEEwwpmNVihZimnBAtMf.svg', link: 'https://eggjs.org',
      },
    ],
  },
  {
    ...
    children: [
      {
        title: 'Instagram', img: 'https://gw.alipayobjects.com/zos/rmsportal/VsVqfjYxPTJaFbPcZqMb.svg', link: 'https://zhuanlan.zhihu.com/xtech',
      },
    ],
  },
];
...
export const page1 = {
  title: 'Why should I sign up for a free account on Influencer\'s Gig X?',
  children: [
    {
      title: 'Search',
      content: 'Find people in our global directory of influencers',
    ...
    {
      title: 'Launch',
      content: 'Free listing on our global directory',
    ...
    {
      title: 'Control',
      content: 'Basic dashboard to update information ',
...
export const page4 = {
  ...
  children: [
    ...
    'https://gw.alipayobjects.com/zos/rmsportal/FdborlfwBxkWIqKbgRtq.svg', // 滴滴出行2
